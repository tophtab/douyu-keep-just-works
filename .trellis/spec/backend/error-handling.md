...
Read [Backend Contracts](./contracts.md#credential-recovery-retry) before
changing CookieCloud-backed recovery, manual-passport recovery, safeAuth/Yuba
retry behavior, or task-runner retry integration.
