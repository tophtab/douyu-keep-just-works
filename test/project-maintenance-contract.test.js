...
test('Docker runtime retries cookie-backed work once after centralized credential recovery', () => {
  ...
  assert.match(runtimeAppContext, /fetchFans: async \(\) => await deps\.runWithCookieSourceRetry/)
  assert.match(runtimeAppContext, /fetchYubaStatus: async \(\) => await deps\.runWithCookieSourceRetry/)
