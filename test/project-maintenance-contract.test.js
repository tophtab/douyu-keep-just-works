...
test('manual passport cookie stays masked outside raw config and is saved from login config UI', () => {
  ...
  const cookieSourceSummary = readRepoFile('src/docker/cookie-source-summary.ts')
  ...
  assert.match(cookieSourceSummary, /export function maskManualPassport/)
  assert.match(cookieSourceSummary, /export function maskManualCookies/)
  assert.match(cookieSourceSummary, /export function maskCookieCloud/)
  assert.match(configRoutes, /function maskConfigManualPassport/)
  assert.match(configRoutes, /from '\.\/cookie-source-summary'/)
